export const menu = [
  {
    ...
    icon: "campus",
    description:
      "A unique, exclusive space for college students on HR Network  .",
  },
  {
    name: "Events",
    icon: "events",
  ...
  },
  {
    name: "Pages",
    icon: "pages",
    description: "Discover and connect with businesses on HR Network  .",
  },
  {
    name: "Gaming Video",
    icon: "gaming",
  ...
  },
  {
    ...
    icon: "recent",
    description: "See all the ads you interacted with on HR Network  .",
  },
  {
    name: "Memories",
    icon: "memories",
    description: "Browse your old photos, videos and posts on HR Network  .",
  },
  {
    name: "Saved",
    icon: "saved",
